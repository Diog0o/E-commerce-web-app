...
mongoose.connect("mongodb+srv://dguerreiro30:Diogo12.@cluster0.adj8r.mongodb.net/e-commerce")
...
app.post ('/login', async (req, res) => {
    ...
    if (user){
        ...
        if (passCompare){
            ...
            res.status(400).json({success: false, errors: "Password incorrect"});
        }
    }
    else{
...
app.get('/newcollection', async (req, res) => {
    let products = await Product.find({});
    //vamo +s pegar os 8 ultimos postos na base de dados
